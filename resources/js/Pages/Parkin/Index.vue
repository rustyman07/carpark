		...
		<v-row justify="center" align="center" class="fill-height">
			<v-col cols="12" md="8" lg="6">
				...
				<div class="clock-section pa-8 text-center">
					...
					<div class="vehicle-type-section mb-6">
						<p class="text-body-2 font-weight-medium text-indigo-darken-4 mb-3">
							<v-icon size="18" class="mr-1">mdi-car-info</v-icon>
							Select Vehicle Type
						</p>
						<div class="d-flex gap-3 justify-center">
							<div
								...
								:class="{
									'vehicle-type-card--active': form.vehicle_type === 'car',
								}"
							...
							>
								<v-icon
									size="36"
									:color="
										form.vehicle_type === 'car' ? 'white' : 'indigo-darken-4'
									"
									>mdi-car</v-icon
								>
						...
						<div
							...
							class="text-caption text-red mt-2 text-center"
						>
					...
					<div class="action-buttons">
						<v-btn
							...
							:disabled="
								form.processing || !form.plate_no || !form.vehicle_type
							"
...
const createTicket = () => {
	...
	form.post(route("parkin.store"), {
		onSuccess: () => {
			...
			form.reset("plate_no", "vehicle_type");
		},
		onError: () => {},
	});
};
